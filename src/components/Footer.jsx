...
const Footer = () => {
  ...
  return (
    <footer className={`${styles.flexStart} ${styles.paddingY} flex-col`}>
      <div className={`${styles.flexStart} md:flex-row flex-col md:mb-8 mb-0`}>
      ...
      <div className='w-full flex justify-between items-center md:flex-row flex-col pt-6 border-t-[1px] border-t-[#3f3r45]'>
        <p className='font-poppins font-normal text-center text-[18px] leading-[27px] text-white'>Worked on this by design Marko Petrovic {date.getFullYear()}. All Rights Reserved.</p>
